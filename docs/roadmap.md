...
- [x] **Phase 13 — Production testing**: full test matrix, security review
      (security review complete; full manual test matrix confirmed by user)
- [x] **Phase 14 — Release**: production build, tag v1.0.0
