...
- [ ] **Phase 3 — Foundation**: Composer autoloading, `Configuration` class,
      Gravity Forms detection fix
- [ ] **Phase 3b — S3 foundation**: storage abstraction, `S3Storage`, repaired
      connection test
- [ ] **Phase 4 — Per-form settings**: `FormArchiveSettings` service
- [ ] **Phase 5 — Queue database**: finalised schema, `QueueRepository`
- [ ] **Phase 6 — Capture submissions**: `SubmissionListener`
- [ ] **Phase 7 — Parse Gravity Forms entries**: `EntryParser` + tests
- [ ] **Phase 8 — Archive generation**: `JsonGenerator`, `PdfGenerator` (TCPDF)
- [ ] **Phase 9 — Background processor**: `ObjectKeyFactory`, `ArchiveProcessor`
- [ ] **Phase 10 — Cron and retries**: `QueueWorker`, `Scheduler`, retry schedule
- [ ] **Phase 11 — Alerts and admin**: `FailureNotifier`, dashboard improvements
- [ ] **Phase 12 — Retention and cleanup**: GF retention confirmation, queue
      metadata cleanup
